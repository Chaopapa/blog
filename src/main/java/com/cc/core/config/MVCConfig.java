...
import com.cc.core.config.format.LocalDateFormatter;
import com.cc.core.config.format.LocalDateTimeFormatter;
import com.cc.core.config.format.LocalTimeFormatter;
import com.cc.core.interceptor.AuthorizationInterceptor;
...
public class MVCConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(authorizationInterceptor).addPathPatterns("/api/biz/core/**");
    }
